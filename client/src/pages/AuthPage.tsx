  ...
  return (
    <div dir={isAr ? 'rtl' : 'ltr'} style={{
      ...
      <div style={{
        ...
        {/* Google Sign-In — server-side redirect flow (/api/auth/google) */}
        {mode !== 'forgot' && (
          <>
            <a
              ...
              style={{
                ...
                background: '#fff', border: '1.5px solid #D7E3EE', borderRadius: 12,
                color: NAVY, fontSize: 14, fontWeight: 700, textDecoration: 'none',
                cursor: 'pointer',
              }}
            >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              <div style={{ flex: 1, height: 1, background: '#E2ECF4' }} />
              <span style={{ color: '#7A9BB5', fontSize: 12 }}>{isAr ? 'أو' : 'or'}</span>
              <div style={{ flex: 1, height: 1, background: '#E2ECF4' }} />
            </div>
          </>
        )}
