  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        <img src="/images/aqua.jpg" alt="Aqua" style={{ width: 60, height: 60, borderRadius: 10, objectFit: 'cover' }} onError={(e) => { (e.target as HTMLImageElement).src = '/images/placeholder.png'; }} />
        <div>
...
function SaunaSessionPanel({ sauna, onUpdate, gender = 'female' }: {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        <img src="/images/sauna.jpg" alt="Sauna" style={{ width: 60, height: 60, borderRadius: 10, objectFit: 'cover' }} onError={(e) => { (e.target as HTMLImageElement).src = '/images/placeholder.png'; }} />
        <div>
