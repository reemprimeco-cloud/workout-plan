...
function AddExercisePanel({ color, gender, onAdd, isAr }: {
  ...
  const programExercises = genderProgram.exercises.map(ex => ({
    ...
    image: resolveImageUrl(ex.imageUrl),
    tip: ex.notesAr || '',
    tipEn: ex.notes || '',
    ...
    <div style={{
      ...
      <div style={{ maxHeight: 280, overflowY: 'auto' }}>
        {filtered.map(ex => (
          ...
          >
            {ex.image && (
              <SafeImage src={ex.image} alt={isAr ? ex.nameAr : (ex.nameEn || ex.nameAr)} style={{
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        <SafeImage src="/images/aqua.jpg" alt="Aqua" style={{ width: 60, height: 60, borderRadius: 10, objectFit: 'cover' }} />
        <div>
...
function SaunaSessionPanel({ sauna, onUpdate, gender = 'female' }: {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        <SafeImage src="/images/sauna.jpg" alt="Sauna" style={{ width: 60, height: 60, borderRadius: 10, objectFit: 'cover' }} />
        <div>
